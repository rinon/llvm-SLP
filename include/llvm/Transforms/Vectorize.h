...
struct VectorizeConfigGlobal {
  ...
  /// @brief Initialize the VectorizeConfig from command line options.
  VectorizeConfigGlobal();
};

//===----------------------------------------------------------------------===//
//
// BBVectorizeGlobal - A basic-block vectorization pass.
//
BasicBlockPass *
createBBVectorizeGlobalPass(const VectorizeConfigGlobal &C = VectorizeConfigGlobal());
