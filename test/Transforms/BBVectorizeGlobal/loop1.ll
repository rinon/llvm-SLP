...
; RUN: opt < %s -bb-vectorize-global -bb-vectorize-global-req-chain-depth=3 -bb-vectorize-global-ignore-target-info -instcombine -gvn -S | FileCheck %s
; RUN: opt < %s -basicaa -loop-unroll -unroll-threshold=45 -unroll-allow-partial -bb-vectorize-global -bb-vectorize-global-req-chain-depth=3 -bb-vectorize-global-ignore-target-info -instcombine -gvn -S | FileCheck %s -check-prefix=CHECK-UNRL
