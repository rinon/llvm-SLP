...
; RUN: opt < %s -bb-vectorize-global -bb-vectorize-global-req-chain-depth=3 -bb-vectorize-global-vector-bits=192 -bb-vectorize-global-ignore-target-info -instcombine -gvn -S | FileCheck %s
