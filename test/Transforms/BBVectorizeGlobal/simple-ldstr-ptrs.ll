...
; RUN: opt < %s -bb-vectorize-global -bb-vectorize-global-req-chain-depth=3 -instcombine -gvn -S | FileCheck %s
; RUN: opt < %s -bb-vectorize-global -bb-vectorize-global-req-chain-depth=3 -bb-vectorize-global-aligned-only -instcombine -gvn -S | FileCheck %s -check-prefix=CHECK-AO
