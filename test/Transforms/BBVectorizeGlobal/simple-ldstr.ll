...
; RUN: opt < %s -bb-vectorize-global -bb-vectorize-global-req-chain-depth=3 -bb-vectorize-global-aligned-only -bb-vectorize-global-ignore-target-info -instcombine -gvn -S | FileCheck %s -check-prefix=CHECK-AO
